...
pub(crate) const REGISTRY: &[Binding] = &[
    ...
    Binding {
        intent: Intent::MediaPlayPause,
        name: "media_play_pause",
        default_keys: &[KeyCode::Char('p')],
        description: "Toggle play/pause of the selected video.",
        category: "View & layout",
    },
    Binding {
        intent: Intent::MediaSeekBack,
        name: "media_seek_back",
        default_keys: &[KeyCode::Char('{')],
        description: "Seek the selected video back.",
        category: "View & layout",
    },
    Binding {
        intent: Intent::MediaSeekForward,
        name: "media_seek_forward",
        default_keys: &[KeyCode::Char('}')],
        description: "Seek the selected video forward.",
        category: "View & layout",
    },
    Binding {
        intent: Intent::MediaRestart,
        name: "media_restart",
        default_keys: &[KeyCode::Char('0')],
        description: "Restart the selected video from the beginning.",
        category: "View & layout",
    },
    Binding {
...
mod tests {
    ...
    const BINDINGS: &[(KeyCode, Intent)] = &[
        ...
        (KeyCode::Char('p'), Intent::MediaPlayPause),
        (KeyCode::Char('{'), Intent::MediaSeekBack),
        (KeyCode::Char('}'), Intent::MediaSeekForward),
        (KeyCode::Char('0'), Intent::MediaRestart),
