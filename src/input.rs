...
pub(crate) const REGISTRY: &[Binding] = &[
    ...
    Binding {
        intent: Intent::ToggleSessionView,
        name: "session_view",
        default_keys: &[KeyCode::Char('s')],
        description: "Show the files the current Claude Code session touched, or restore the full tree.",
        category: "Session",
    },
    Binding {
        intent: Intent::OpenSessionPicker,
        name: "session_picker",
        default_keys: &[KeyCode::Char('S')],
        description: "Open the session picker to choose which Claude Code session is shown.",
        category: "Session",
    },
    Binding {
...
mod tests {
    ...
    const BINDINGS: &[(KeyCode, Intent)] = &[
        ...
        (KeyCode::Char('s'), Intent::ToggleSessionView),
        (KeyCode::Char('S'), Intent::OpenSessionPicker),
