...
### Added
- Advisory remote notices: project spotlights and available-update details now share the status footer and **What's New**. → [usage](docs/usage.md#staying-up-to-date)
