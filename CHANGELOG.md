...
### Changed
- Settings tab shows each setting's effective value instead of a `(default)` placeholder; the renderer rows name the program that runs. → [configuration](docs/configuration.md)
