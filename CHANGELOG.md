...
## [1.8.0-preview.1] - 2026-07-01

_Pre-release for real-hardware validation (GitHub #58) — flagged a GitHub pre-release, not a
stable release. Install with `--ref v1.8.0-preview.1`. Windows stays labelled **preview**._
